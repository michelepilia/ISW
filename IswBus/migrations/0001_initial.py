# Generated by Django 2.0.6 on 2018-06-16 18:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('numero', models.CharField(default='1111222233334444', max_length=16, verbose_name='Numero Carta di Credito')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cognome', models.CharField(default='Cognome', max_length=50, verbose_name='Cognome')),
                ('django_user', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='transazione',
            name='utente',
            field=models.ForeignKey(default=IswBus.models.Utente(), on_delete=django.db.models.deletion.CASCADE, to='IswBus.Utente'),
        ),
        migrations.AddField(
